...
<div class="row">
                        <div class="col-md-12">
                            <div class="card card-topline-gray">
                                <div class="card-head">
                                    <header>Charter Transport Manage</header>
                                    <div class="tools">
                                ...
                                <div class="card-body ">
                                    <div class="row p-b-20">
                                      <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <button id="addRow1" class="btn" style="background-color: #628dab;color:#ffffff;" onclick="window.location.href='<?php echo base_url('Chartertransport')?>'">
...
if(isset($get_chartertran_list)){
 foreach($get_chartertran_list as $value_list){  
    $i++;
    $get_chartertran_title = $this->Chartertran_model->get_chartertran_title($value_list->id);
...
?>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td align="center"> 
                                                  <!--
-->                       <button id="addRow1" class="btn select_bt" onclick="window.location.href='<?php echo base_url('Chartertransport/ChartertransportDetail/').$value_list->id?>'">
  ...
  if(idtyp==2){txttyp="warning";}
	...
	function delete_data(dataID){  
             if (confirm("Want to delete this data ?")) {
                $.post('<?php echo base_url('ChartertransportList/deleteData')?>' , { dataID : dataID }, 
		function(data){  
		if(data==1){ 
                	show_msg("Save Success",1);
                  setTimeout(function(){ window.location.href = "<?php echo base_url('ChartertransportList')?>"; }, 2000);
			}else{
			return false;
			}
			});	
