            ...
            if($chk_hotel>0){
                 ...
                 foreach($book_room_detail as $val_sec){
                  $st_txt = "";
                     ...
                     $st = $val_sec->booking_stat_cd;
                     $date_in =  $val_sec->date_in;
                     $date_out = $val_sec->date_out;

      if($st==1){
           $st_txt = "<font color='green'>Payment</font>";
      }else if($st=="I"){
           $st_txt = "<font color='blue'>Pending</font>";
      }
                  }
...
Phone:+66 (0) 74 750777, +66 (0) 91 301 3012, +66 (0) 91 301 3013
    ...
    <div class="col-md-4" style="text-align:right;margin-top: 15px;font-size:15px;">
      ...
      Booking Date: May 25, 2018<br>
      Booking Status: <b><?php echo$st_txt?></b>
    </div>
    </div>
   ...
   <div class="col-md-4" style="border-right:4px solid #1c8bb8;height: 70px;font-size:15px;">
      Booked and payable by Khemtis
   </div>

   <div class="col-md-4" style="border-right:4px solid #1c8bb8;height: 70px;font-size:15px;">
Check-in<br>
<b><?php echo$date_in?></b>
    </div>
    <div class="col-md-4" style="font-size:15px;">
Check-out<br>
<b><?php echo$date_out ?></b>
    </div>
</div>
</div>
