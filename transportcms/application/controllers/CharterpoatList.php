...
class CharterpoatList extends CI_Controller {
	...
	public function index(){
	  ...
	  //$data["get_boat"]= $this->Boat_model->get_boat_detail($boat_id);
          $data["get_chartertran_list"]= $this->Charterpoat_model->get_chartertran_list($idclient);
	  $this->load->view('Header',$data);// Load Heder And Script Top Page
	  //$this->load->view('Home');
	  $this->load->view('CharterpoatManageList_view',$data);
 ...
 //-------------------
	public function deleteData(){  
		...
		$Result = $this->Charterpoat_model->deleteDatacharter($dataID);
		echo $Result;	
	}
