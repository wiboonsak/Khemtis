...
function get_booking_list($idclient,$filter){
  $txt_filter = "";
  if($filter!="all"){
     $txt_filter = "  WHERE  tbl_pre_transport_booking_title.booking_status = '$filter'  ";
  }
$sql_detail = "SELECT  tbl_pre_transport_booking_title.id,
...
tbl_pre_transport_booking_title.booking_status,
tbl_gp_booking.add_date,
tbl_gp_booking_detail.id_gp_booking,
sum(tbl_pre_transport_booking_detail.total_price) as book_price,
sum(tbl_pre_transport_booking_detail.total_comm) as comm_price
FROM tbl_pre_transport_booking_detail 
     ...
     AND tbl_transport_route_data.client_id=$idclient
$txt_filter
   GROUP BY 
...
tbl_gp_booking.add_date,
tbl_gp_booking_detail.id_gp_booking 
   ORDER BY tbl_pre_transport_booking_title.id DESC
";
//echo $sql_detail;
    return $this->db->query($sql_detail)->result();
}
