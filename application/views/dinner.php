...
<html lang="en">
    <head>
        <title>KHEMTHIS | เข็มทิศ จองห้องพัก จองโรงแรม จองรีสอร์ท เกาะหลีเป๊ะ ราคาถูก</title>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="รับประกันราคาดีที่สุดสำหรับโรงแรม รีสอร์ท โฮสเทล บ้านพัก สปีดโบ๊ท รถรับส่งสนามบิน แพคเก็จทัวร์ ร้านอาหาร และอื่นๆ อีกมากมายทั่วโลก ช่วยท่านค้นเจอที่พักถูกใจ" />
    	<meta name="keywords" content="Khemtis, เข็มทิศ, จองโรงแรม, รีสอร์ท, ที่พัก, ทัวร์, เกาะหลีเป๊ะ, ประเทศไทย, ต่างประเทศ, จองโรงแรมออนไลน์, จองห้องพัก, สำรองห้องพัก, เอเชีย, ยุโรป, อเมริกา, จองเรือ, จองรถตู้, จองทริปท่องเที่ยว, สปีดโบ๊ท, รถรับส่งสนามบิน, แพคเก็จทัวร์, ร้านอาหาร, เกาะเต่า, เกาะล้าน, เกาะสมุย, เกาะพะงัน" />
            ...
            <div class="wrapper-content">
                ...
                <div id="wrapper-content">
                    ...
                    <div class="main-content">
                       	<section class="page-banner bg-faq" style="background-image: url('assets/images/background/homepage-02-banner-2.jpg');">
                            <div class="container">
                                <div class="page-title-wrapper">
                                    <div class="page-title-content">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active">
                                                <a href="#" class="link">dinner</a>
                                            </li>                                            
                                        </ol>
                                        <div class="clearfix"></div>
                                        <h2 class="captions">DINNER</h2>
                                    </div>
                                </div>
                            </div>
                        </section>
                                            ...
                                            <ul role="tablist" class="nav nav-tabs">
                                                <li role="presentation" class="tab-btn-wrapper active">
                                                   <a href="#cruises" aria-controls="cruises" role="tab" data-toggle="tab" class="tab-btn">
                                                        ...
                                                        <span class="text">BOAT TRANSFER</span>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="tab-content">
                                                    <div role="tabpanel" id="dinner" class="tab-pane fade in active">
                                                        <div class="find-widget find-transfer-widget widget">
                                                            <h4 class="title-widgets">FIND DINNER</h4>
                                                            <form class="content-widget">                                                                
                                                                <div class="text-input small-margin-top">
                                                                    <div class="place text-box-wrapper">
                                                                        <label class="tb-label">Which restaurant would you like to go to?</label>
                                                                        <div class="select-wrapper">
                                                                            <!--i.fa.fa-chevron-down-->
                                                                            <select class="form-control custom-select selectbox">
                                                                                <option selected="selected">Select Resturant</option>
                                                                                <option>ART BEACH CLUB</option>
                                                                                <option>SUGOI TEPPANYAKI</option>
                                                                                <option>CHILL OUT BAR</option>
                                                                                <option>SHINE BAR</option>
                                                                                <option>THE STEAK HOUSE</option>
                                                                            </select>
                                                                        </div>                                                                           
                                                                    </div>
                                                                    ...
                                                                    <button type="submit" data-hover="NEXT" class="btn btn-slide">
                        ...
                        <section class="tours padding-top padding-bottom"  style="padding-bottom: 20px; padding-top: 20px; background-image:url(assets/images/background/bg-dinner.jpg)  !important">
                            <div class="container">
                                <div class="tours-wrapper">
                                    <div class="group-title">
                                        <div class="sub-title">
                                            <p class="text">Restaurants/Bars</p>
                                            <i class="icons flaticon-people"></i>
                                        </div>
                                        <h2 class="main-title">in Lipe with the best view</h2>
                                    </div>                                    
																...
																<div class="row">
																	<div class="col-sm-4">
																		<div class="tours-layout">
																			<div class="image-wrapper">
																				<a href="#" class="link">
																					<img src="assets/images/dinner/artbeach.jpg" alt="" class="img-responsive">
																				</a>
																				<div class="title-wrapper">
																					<a href="#" class="title">ART BEACH CLUB</a>
																					<i class="icons flaticon-circle"></i>
																				</div>
																				<div class="label-sale">
																					<p class="text">special</p>
																					<p class="number">1,500 Baht</p>
																				</div>
																			</div>
																			<div class="content-wrapper">
																				<ul class="list-info list-inline list-unstyle">
																					<li>
																						<a href="#" class="link">
																							...
																							<span class="text number">578</span>
																						</a>
																					</li>
																					<li>
																						<a href="#" class="link">
																				...
																				<div class="content">
																					<div class="title">
																						<div class="price">
																							<span class="number">start 1,500 Baht</span>
																						</div>
																						<!--<p class="for-price">ART BEACH CLUB</p>-->
																					</div>
																					<p class="text">Take the Koh Lipe package with us and travel with peace of mind whether you traveling with family, friends outings, couple, honeymooner or company trip. </p>
																					<div class="group-btn-tours">
																						<a href="#" class="left-btn">book now</a>
																						<a href="news_detail.php" class="right-btn">contact</a>
																					</div>
																				</div>
																			</div>
																		</div>
																	...
																	<div class="col-sm-4">
																		<div class="tours-layout">
																			<div class="image-wrapper">
																				<a href="#" class="link">
																					<img src="assets/images/dinner/sugui.jpg" alt="" class="img-responsive">
																				</a>
																				<div class="title-wrapper">
																					<a href="#" class="title">SUGOI TEPPANYAKI JAPANESE RESTAURANT</a>
																					<i class="icons flaticon-circle"></i>
																				</div>
																				<div class="label-sale">
																					<p class="text">special</p>
																					<p class="number">3,000 Baht</p>
																				</div>
																			</div>
																			<div class="content-wrapper">
																				<ul class="list-info list-inline list-unstyle">
																				...
																				<div class="content">
																					<div class="title">
																						<div class="price">
																							<span class="number">3,000 Baht</span>
																						</div>
																						<!--<p class="for-price">SUGOI TEPPANYAKI JAPANESE RESTAURANT</p>-->
																					</div>
																					<p class="text">Take the Koh Lipe package with us and travel with peace of mind whether you traveling with family, friends outings, couple, honeymooner or company trip. </p>
																					<div class="group-btn-tours">
																						<a href="#" class="left-btn">book now</a>
																	...
																	<div class="col-sm-4">
																		<div class="tours-layout">
																			<div class="image-wrapper">
																				<a href="#" class="link">
																					<img src="assets/images/dinner/shinebar.jpg" alt="" class="img-responsive">
																				</a>
																				<div class="title-wrapper">
																					<a href="#" class="title">SHINE BAR</a>
																					<i class="icons flaticon-circle"></i>
																				</div>
																				<div class="label-sale">
																					<p class="text">special</p>
																	...
																	<div class="col-sm-4">
																		<div class="tours-layout">
																			<div class="image-wrapper">
																				<a href="#" class="link">
																					<img src="assets/images/dinner/chilloutbar.jpg" alt="" class="img-responsive">
																				</a>
																				<div class="title-wrapper">
																					<a href="#" class="title">CHILL OUT BAR</a>
																					<i class="icons flaticon-circle"></i>
																				</div>
																				<div class="label-sale">
																					<p class="text">special</p>
																			...
																			<div class="content-wrapper">
																				...
																				<div class="content">
																					<div class="title">
																						...
																						<!--<p class="for-price">CHILL OUT BAR</p>-->
																					</div>
																					<p class="text">Take the Koh Lipe package with us and travel with peace of mind whether you traveling with family, friends outings, couple, honeymooner or company trip. </p>
																					<div class="group-btn-tours">
																						<a href="#" class="left-btn">book now</a>
																	...
																	<div class="col-sm-4">
																		<div class="tours-layout">
																			<div class="image-wrapper">
																				<a href="#" class="link">
																					<img src="assets/images/dinner/thesteak.jpg" alt="" class="img-responsive">
																				</a>
																				<div class="title-wrapper">
																					<a href="#" class="title">THE STEAK HOUSE</a>
																					<i class="icons flaticon-circle"></i>
																				</div>
																				<div class="label-sale">
																					<p class="text">special</p>
																			...
																			<div class="content-wrapper">
																				...
																				<div class="content">
																					<div class="title">
																						...
																						<!--<p class="for-price">THE STEAK HOUSE</p>-->
																					</div>
																					<p class="text">Take the Koh Lipe package with us and travel with peace of mind whether you traveling with family, friends outings, couple, honeymooner or company trip. </p>
																					<div class="group-btn-tours">
																						<a href="#" class="left-btn">book now</a>
