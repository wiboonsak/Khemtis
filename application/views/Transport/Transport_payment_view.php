...
<center>
  ...
  $getbooking_title = $this->Routetranfer_model->getbooking_title($keygroub);
          ...
          <?php $list_placedes = $this->Routetranfer_model->list_placeData($list_route2->destination_place_id);
                        ...
                        $Routetype = $this->Routetranfer_model->get_routeType($route_id, $getbooking_title2->route_type_id, $r, 'yes', 'id');
...
<?php echo $list_placebegin2->place_title?> <i class="fa fa-arrow-right" aria-hidden="true"></i> <?php  echo $list_placedes2->place_title?>
														        ...
														        <tr>
                                                                  ...
                                                                  <td>  <?php echo $getbooking_title2->cust_name?></td>
																</tr>


																<tr>
																  <td align="left">&nbsp;Departing</td>
...
<div class="contact-submit" align="center" style="margin:20px 0px !important">
       ...
       <?php include("modal_login_register.php"); ?>
        ...
        <script>
        function up_pay() {
        var keygroup = '<?php echo $keygroub?>';
      $.post("<?php echo base_url('Transport/Routetranfer/confrim_data')?>", 
      {keygroup:keygroup},
        function(result){
