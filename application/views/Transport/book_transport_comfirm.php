<div class="main">
  ...
  $getbooking_title = $this->Routetranfer_model->getbooking_title($keygroub);
          ...
          ?>
                                      <h3 style="font-size: 18px !important"><i class="fa fa-ship" aria-hidden="true"></i> <?php echo $list_placebegin2->place_title?> <i class="fa fa-arrow-right" aria-hidden="true"></i> <?php  echo $list_placedes2->place_title?></h3><br>
				 <?php 
                                    ...
                                    <div class="total-trip">
                                        <span>
                                           BOOKING ID: <?php echo $keygroub?>
                                            <br>
                                            <?php echo number_format($getbooking_title2->total_price)?> THB<small>/ <?php echo $totalpeople?> <?php if($totalpeople >1){echo 'Travellers';}else{echo 'Traveller';}?></small>
                                        </span>
...
<p><button type="button" class="" data-toggle="collapse" data-target="#price1<?php echo $checkDetail2->id?>" style="font-size: 10pt !important"> <?php echo $totalpeople?> <?php if($totalpeople >1){echo 'Travellers';}else{echo 'Traveller';}?> = <?php echo number_format($totalprice)?> THB <span style="float: right; padding-left: 15px;"> <i class="fa fa-chevron-down" aria-hidden="true"></i> </span></button>
 ...
 <?php echo $list_placebegin2->place_title?> <i class="fa fa-arrow-right" aria-hidden="true"></i> <?php  echo $list_placedes2->place_title?>
																  </p></td>
																</tr>
																<tr>
																  <td align="left"><i class="fa fa-arrow-right" aria-hidden="true"></i>&nbsp;Departing</td>
                                                                  <td> <?php echo $dayofweek?>, <?php echo $this->Routetranfer_model->GetEngDateTime2($getbooking_title2->date_depart);?></td>
																</tr>
                                                                <tr>
                                                                  <td align="left"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;Return</td>
                                                                  <td> <?php echo $dayofweek?>, <?php echo $this->Routetranfer_model->GetEngDateTime2($getbooking_title2->date_return);?></td>
                                                                </tr>
															  	<tr>
																  <td align="left"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;Total Guests</td>
                                                                  <td>Adults:<?php echo $adultstravel?>&nbsp;Child:<?php echo $childtravel?></td>
																</tr>
																<tr>
                                                    ...
                                                    <table width="100%">
                                                       <tr><td><?php echo $totalpeople?> <?php if($totalpeople >1){echo 'Travellers';}else{echo 'Traveller';}?></td><td style="text-align:right">&nbsp;<?php echo number_format($getbooking_title2->total_price,2)?>&nbsp;THB</td></tr>
                                                       <tr><td> Total: </td><td style="text-align:right"><b>&nbsp;<u><?php echo number_format($getbooking_title2->total_price,2)?></u></b>&nbsp;THB</td></tr>
                                                    </table>
  ...
  text-decoration-style: double;"><?php echo number_format($getbooking_title2->total_price,2)?></font>&nbsp;THB&nbsp;&nbsp;</td>
																</tr>																
															  </tbody>
															</table>
                                                       </div>
                                ...
                                <br>
                                <br>
                                <div class="submit text-center" style="text-align:left" >
                            <p>
...
<!--							<button class="awe-btn awe-btn-1 awe-btn-lager" >PRINT PACKAGE BOOKING</button>-->
...
//$('#routemodal').empty();
	...
	$( '#exampleModal' ).modal( 'show' );
        ...
        window.location.href = "<?php echo base_url('Transport/Routetranfer/TransportPayment/') ?>"+keygroub;
