...
<?php $alltotal = 0;
function conv_img($urlty){
  // Get the image and convert into string 
$img = file_get_contents($urlty); 
...
<div style="width:100%;border-style: solid;border-width:0px;">
  <table>
    <tr><td colspan="2" style="font-size:25px!important;height: 35px!important;padding-bottom:10px!important"><b>Hotel Voucher</b></td>
    <td style="text-align: right;"><img src="data:image/png;base64,<?php echo conv_img('https://www.khemtis.com/assets/images/logo-khemtis-black.jpg');?>" style="height:auto;width:120px;top:0px!important;"></td></tr>
    <tr><td>
      <font style="font-size:18px;font-weight:bold;">Booking ID</font><br>
      H<?php echo$book_id_hotel?>
    </td>
    <td>
      <font style="font-size:18px;font-weight:bold;">Khemtis Company</font><br>
...
<tr><td colspan="1">
    <table>
       <tr><td style="text-align:right">Customer Name : </td><td class="frt">&nbsp;<?php echo$cus_name?></td></tr>
...
<td>
Check-in<br>
<b><?php echo $date_in;// echo frmd($date_check_in)?></b>
</td>
<td>
Check-out<br>
<b><?php echo $date_out;// echo frmd($date_check_in)?></b>
</td>
</tr>
</table>
<br>
 ...
 <table style="width:100%">
    ...
    <?php
     ...
     ?>
      ...
      <?php } ?>
      <tr><td colspan="4" style="text-align: right;"> Sub-total:&nbsp;&nbsp;<b><u><?php echo number_format($sumtotal,2)?></u></b></td></tr>
      </tbody>
...
<div style="width:100%;border-style: solid;border-width:0px;">
  ...
  <table>
    <tr><td colspan="2" style="font-size:25px!important;height: 35px!important;padding-bottom:10px!important"><b>Package Voucher</b></td>
    <td style="text-align: right;"><img src="data:image/png;base64,<?php echo conv_img('https://www.khemtis.com/assets/images/logo-khemtis-black.jpg');?>" style="height:auto;width:120px;top:0px!important;"></td></tr>
    <tr><td>
...
<td colspan="2">
Check-in<br>
<b><?php echo$date_check_in;// echo frmd($date_check_in)?></b>
</td>
</tr>
</table>
...
Number of people</td><td style="text-align:right">Price</td>
  ...
  <?php } ?>
   <tr><td colspan="3" style="text-align: right;"> Sub-total:&nbsp;&nbsp;<b><u><?php echo number_format($sum_all_bill,2)?></u></b></td></tr>
    </tbody>
   ...
   $sum_all_bill = ($sum_all_bill + $value_extra->price);
    ?>
     <tr><td><?php echo$value_extra->extra_name?></td>
      ...
      <td style="text-align:right"><?php echo number_format($value_extra->price,2)?>฿</td></tr>
  <?php } ?>
  <tr><td colspan="5" style="text-align: right;"> Sub-total:&nbsp;&nbsp;<b><u><?php echo number_format($sum_all_bill,2)?></u></b></td></tr>
    </tbody>
...
<div style="width:100%;border-style: solid;border-width:0px;">
  <table>
    <tr><td colspan="2" style="font-size:25px!important;height: 35px!important;padding-bottom:10px!important"><b>Transport Voucher</b></td>
    <td style="text-align: right;"><img src="data:image/png;base64,<?php echo conv_img('https://www.khemtis.com/assets/images/logo-khemtis-black.jpg');?>" style="height:auto;width:120px;top:0px!important;"></td></tr>
    <tr><td>
      <font style="font-size:20px;font-weight:bold;">Booking ID</font><br>
      P<?php echo$book_id_p?>
    ...
    if($FromLocationName!=""){ ?>
     ...
     <div class="col-md-6">
                        <table class="table" width="100%" style="font-size: 15px;">
                           <tr><td colspan="2" style="color:#000000"><b><?php echo$compay_de?></b></td></tr>
                          <tr>
...
$newformat = date('d-M-Y',$time1);
        ...
        <div class="col-md-6">
                           <table class="table" width="100%" style="font-size: 15px;">
                             <tr><td colspan="2" style="color:#000000"><b><?php echo$compay_re?></b></td></tr>
                          <tr>
...
$newformat = date('d-M-Y',$time);
         ...
         <div style="margin-top:10px;width:100%;text-align: right;">  Sub-total:&nbsp;&nbsp;<b><u><?php echo number_format(($sum1+$sum2),2)?></u></b></div>
...
<table>
    <tr><td colspan="2" style="font-size:25px!important;height: 35px!important;padding-bottom:10px!important"><b>Resturants Voucher</b></td>
    <td style="text-align: right;"><img src="data:image/png;base64,<?php echo conv_img('https://www.khemtis.com/assets/images/logo-khemtis-black.jpg');?>" style="height:auto;width:120px;top:0px!important;"></td></tr>
    <tr><td>
      <font style="font-size:18px;font-weight:bold;">Booking ID</font><br>
...
Number of people</td><td style="text-align:right">Price</td><td style="text-align:right">Total price</td>
          ...
          <?php if($sg>0){?><tr><td><b>Single</b></td><td><?php echo$sg?></td><td  style="text-align:right"><?php echo number_format($sg_p,2)?></td><td style="text-align:right"><?php echo number_format($total3,2)?></td></tr><?php }?>
           ...
           $alltotal=($alltotal+($total));
            ?>
<div style="margin-top:10px;width:100%;text-align: right;">  Sub-total:&nbsp;&nbsp;<b><u><?php echo number_format($total,2)?></u></b></div>            
<div style="border-top:1px solid #cccccc;border-bottom:1px solid #cccccc;">
  <div class="row">
    <div class="col-md-6"  style="font-size:15px;">
   Customer Service<br>
