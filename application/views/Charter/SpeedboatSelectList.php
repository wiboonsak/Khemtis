                                    ...
                                    <div class="responsive-table ">
										...
										<table class="table flight-table table-radio">
                                            ...
                                            <tbody>
                                                ...
                                                $listpriceland = $this->Charter_model->listpriceland($getLandData2->id);
							...
							<tr>
								...
								<td class="td-airline text-center">
									...
									<div class="radio-checkbox ">
                                                                            ...
                                                                            <input type="checkbox" name="airline"  id="radio-air-<?php echo $Data->id?>" class="new_radio rowtd" onclick="adddetail(this.checked,'<?php echo $getLandData2->id?>','<?php echo $Data->id?>','<?php echo $transport_name?>','<?php echo $Data->price?>','1','<?php echo $datetotal?>');">
