                                ...
                                <div class="page-title-wrapper">
                                    <div class="page-title-content">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active">
                                                <a href="#" class="link">PACKAGAE TOURS</a>
                                            </li>                                            
                                        </ol>
                                        <div class="clearfix"></div>
                                        <h2 class="captions">PACKAGAE TOURS</h2>
                                    </div>
                                </div>
                            </div>
                        </section>
                                                ...
                                                <div class="tab-content">
                                                   	<div role="tabpanel" id="tours" class="tab-pane fade in active">
                                                        <div class="find-widget find-tours-widget widget">
                                                            <h4 class="title-widgets">FIND PACKAGE TOURS</h4>
                                                                    ...
                                                                    <div class="place text-box-wrapper">
                                                                        ...
                                                                        <div class="select-wrapper">
                                                                            ...
                                                                            <select class="form-control custom-select selectbox">
                                                                                <option selected="selected">Select Tours</option>
                                                                                <option>1 Days Lipe Trip - 1,900 Baht</option>
                                                                                <option>2 Days Lipe Trip - 2,900 Baht</option>
                                                                                <option>3 Days Lipe Trip - 3,900 Baht</option>
                                                                            </select>
                                                                        </div>                                                                           
                                                                    </div>
                                    ...
                                    <div class="list-continents">
                                        <div class="list-continent-wrapper">
                                            <a href="#" class="continent">
                                                ...
                                                <span class="text">HATYAI</span>
                                            </a>
                                        </div>
                                        <div class="list-continent-wrapper">
                                            <a href="#" class="continent">
                                                <i class="icons fa fa-map-marker"></i>
                                                <span class="text">PAKBARA</span>
                                            </a>
                                        </div>
                                        <div class="list-continent-wrapper">
                                            <a href="#" class="continent">
                                                <i class="icons fa fa-map-marker"></i>
                                                <span class="text">KOH LIPE</span>
                                            </a>
                                        </div>
                                        <div class="list-continent-wrapper">
                                            <a href="#" class="continent">
                                                <i class="icons fa fa-map-marker"></i>
                                                <span class="text">KHAI ISLAND</span>
                                            </a>
                                        </div>
                                        <div class="list-continent-wrapper">
                                            <a href="#" class="continent">
                                                <i class="icons fa fa-map-marker"></i>
                                                <span class="text">ADANG-RAWI</span>
                                            </a>
                                        </div>
                                    </div>
            				                                ...
            				                                <div class="tours-layout">
																<div class="image-wrapper">
																	...
																	<div class="title-wrapper">
																		<a href="#" class="title">3 Days 2 Nights Koh Lipe</a>
