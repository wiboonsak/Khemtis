...
<!DOCTYPE html>
<?php $pthc= base_url();
  if($this->session->userdata('chk_pay')=="paymentalll"){
...
<div id="myLinks">
    <a href="<?echo base_url("")?>" class="mobile_list"><img src="http://www.khemtis.com/assets/icon/hotel_icon.png" style="width:15px;">&nbsp;&nbsp;<?php echo$list_lang[0]?></a>
...
?>
                    ...
                    <div class="bg-white header-02 pc_nav">
                        <div class="header-topbar" style="background-image: linear-gradient(#e2e2e2, #ffffff,#ffffff)!important;padding-left:20px;padding-top: 5px">
                                        <div class="logo">
                        ...
                        <?php if($this->session->userdata('fname_member')==""){?>
                           <li><button id="login_mh" type="button" data-toggle="modal" data-target="#login" style="border: none; background: none;font-weight: bold;">-</button></li>
                        <?php  }else{?>
                           <li><a href="<?php echo$pthc?>Member/ProfileBook" class="link_mem"><i class="fa fa-id-card-o"></i></a></li><a href="<?php echo$pthc?>Member/ProfileBook" class="link_mem"><?php echo$this->session->userdata('fname_member')?>&nbsp;&nbsp;<?php echo$this->session->userdata('lname_member')?></a>
                        ...
                        <?php }?>
                         <?php if($this->session->userdata('fname_member')==""){?>
                        <li><button type="button" data-toggle="modal" data-target="#register" style="border: none; background: none;font-weight: bold;">Home</button></li>
                         <?php }?>
                        </ul>
                            </div>
                        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel2">Booking Summary</h4>
        </div>

<table style="width:100%!important"><tr><td style="padding: 0px;background-color:#ffdd00" valign="top">


<table class="noneborder" style="width:150px!important;"><tr><td>
<div class="clck_ch" onclick="clk_menu(1)" id="bt1" style="padding:6px;width:10px!important;cursor: pointer;">
<img src="http://www.khemtis.com/assets/icon/hotel_icon.png" style="width:23px;" >
</div>
</td><td>
<div  class="clck_ch" onclick="clk_menu(2)" id="bt2" style="padding:6px;width:10px!important;cursor: pointer;">
<img src="http://www.khemtis.com/assets/icon/route_con.png" style="width:23px;" >
</div>
</td><td>
<div  class="clck_ch" onclick="clk_menu(3)" id="bt3" style="padding:6px;width:10px!important;cursor: pointer;">
<img src="http://www.khemtis.com/assets/icon/package_icon.png" style="width:23px;" >
</div>
</td><td>
<div  class="clck_ch" onclick="clk_menu(4)" id="bt4" style="padding:6px;width:10px!important;cursor: pointer;">
...
<div style="width:100%"><table style="width:100%"><tr><td>Total price All :</td><td style="text-align: right;"><div style="color:red;font-weight:bold;" id="all_price">&nbsp;0</div></td></tr></table></div>

       <div  style="text-align:center;cursor: pointer;font-size:20px;padding-bottom: 10px;width:100%;margin-top: 5px;" > <center>  

           <div class="bt_book" id="hotel_001" onclick="window.location='https://www.khemtis.com'">Hotel Book</div>
           <div class="bt_book" id="pack_001" onclick="pack_link()">Package Book</div>
           <div class="bt_book" id="trans_001" onclick="tran_link()">Transport Book</div>
           <div class="bt_book" id="restur_001" onclick="res_link()">Restuarants Book</div>
       ...
       <div  style="text-align:center;cursor: pointer;font-size:20px;padding-bottom: 10px;width:100%;margin-top: 10px;" > <center>  
   ...
   <input type="hidden"  name="sum_res_val" id="sum_res_val" value="0">
    ...
    <form action="<?php echo$pthc?>AllBooking" method="post" name="frm_go_p" id="frm_go_p">
      ...
      <div class="box_icon_pay" id="box_icon_pay" onclick="submit_pay()"
           style="margin-left:4px;width:100%;padding: 3px 10px 3px 10px;border-radius:0px;margin-right: 20px;background-color:#3057d5;color:#ffffff">Pay</div>
    </form>
...
function page_load(){
  var type_page = $('#type_page').val();
   if(type_page==1){
      $('#hotel_001').css("display","none");
   }
   if(type_page==2){
      $('#pack_001').css("display","none");
   }
   if(type_page==3){
      $('#trans_001').css("display","none");
   }
      if(type_page==4){
      $('#restur_001').css("display","none");
   }
}
function chk_time(){
...
function log_out(){
         $.ajax({
                    ...
                    data: ({idhd:''}),
                  success:function(data) {
                     window.location='https://www.khemtis.com';
                  }
         });
}
...
function del_hotel_list_temp(hotel_id,txt_find,book_st,book_en,Adults,Child){
    var del_temp = $('#del_temp').val();
             $.ajax({
              ...
              if(data==1){
                     show_booklist(0,0);
                     window.location ='https://www.khemtis.com/HotelView?lang=en&hotel_id='+hotel_id+'&txt_find='+txt_find+'&book_st='+book_st+'&book_en='+book_en+'&Adults='+Adults+'&Child='+Child+'';
              }
