    ...
    <div style="width:50%;">
      <ul class="progressbar">
        ...
        <li>Booking is confirmed!</li>
                                                ...
                                                <center>
                                                        <h4 class="title">BOOKING DETAIL SUMMARY</h4>   
                                                </center>
...
$dis_count_txt = 0;
 ...
 if (isset($dis_count)){
        $code_dec_txt =  $dis_count->hotel_code;
        $code_dec_txt = explode("<-->", $code_dec_txt);
        $code_dec_txt = $code_dec_txt[0];
        $dis_count_txt =  $dis_count->hotel_dis;
 }
     ...
     $cus_address = $customer_hotel->cus_addr;
                 ...
                 foreach($book_room_detail as $val_sec){
                     ...
                     $book_id_hotel = str_replace('-','', $val_sec->book_id_hotel).$val_sec->pre_booking_id;
                      ...
                      $book_st_hotel = $date_in;
                      $book_en_hotel = $date_out;
                      $adu_hotel = $adults;
                      $chi_hotel = $child;
...
<div class="container box_all" style="padding-top:50px;margin-bottom: 20px;margin-top: 50px;">
  <input type="hidden" value="<?php echo ch_date($date_in)?>" id="pay_d_st">
  <input type="hidden" value="<?php echo ch_date($date_out)?>" id="pay_d_en">
<div style="width:100%;border-style: solid;border-width:0px;">
  <div class="row">
    <div class="col-md-6" style="font-size: 25px;color:#3599c5"><b>Hotel Detail</b></div>
...
Phone:+66 (0) 74 750777, +66 (0) 91 301 3012, +66 (0) 91 301 3013
    ...
    <div class="col-md-4" style="text-align:right;margin-top: 15px;font-size:15px;">
      ...
      Booking Status: <font color="#4389d2"><b>Pending</b></font>
    </div>
    </div>
...
<?php
if($chk_hotel>0){?>
<div class="box_transport" style="margin-bottom: 50px;margin-top:10px;">
...
<div style="border-top:1px solid #cccccc;border-bottom:1px solid #cccccc;">
  <div class="row">
    ...
    <div class="col-md-12"  style="font-size:15px;text-align: right;">
      <table style="width:100%"><tr><td style="text-align:left;"> Sub-total:&nbsp;&nbsp;</td><td><b><?php echo number_format($sumtotal,2)?></b></td></tr></table>

   </div>
 <div class="col-md-12">
     <table style="width:100%">
      <tr style="color:red"><td>Discount :</td><td style="text-align: right;"><div id="price_pro"><?php echo number_format($dis_count_txt,2)?></div></td></tr>
      <tr style="background-color:#efefef;color:#000000"><td><b>Net total :</b></td><td style="text-align: right;"><div id="price_pro_sum"><?php echo number_format($sumtotal-$dis_count_txt,2)?></div></td></tr>
    </table>
 </div>  
...
<div style="width:100%;border-style: solid;border-width:0px;">
  <div class="row">
    <div class="col-md-6" style="font-size: 25px;color:#3599c5"><b>Transport Detail</b></div>
    <div class="col-md-6" style="text-align: right;"><img src="http://khemtis.com/frontend/assets_bill/images/logo-khemtis-black.png" style="height:auto;width:120px;"></div>
...
Phone:+66 (0) 74 750777, +66 (0) 91 301 3012, +66 (0) 91 301 3013
   ...
   <div class="col-md-12" style="border-bottom-style:solid;border-width: 0px;border-color:#cccccc;height: 15px;"></div>
   <div class="col-md-4" style="height: 70px;font-size:15px;">
    <table>
       <tr><td style="text-align:right">Customer Name : </td><td>&nbsp;<?php echo$cus_name?></td></tr>
       <tr><td style="text-align:right">Tel : </td><td >&nbsp;<?php echo$cus_contact?></td></tr>
       <tr><td style="text-align:right">Email : </td><td >&nbsp;<?php echo$cus_email?></td></tr>
    ...
    if($FromLocationName!=""){ ?>
     ...
     <div class="col-md-<?php echo$span2?>">
                        <table class="table" width="100%" style="font-size: 15px;">
                          <tr><td colspan="2" style="color:#3599c5"><?php echo$compay_de?></td></tr>
                          <tr>
...
$newformat = date('d-M-Y',$time1);
                          ...
                          <tr>
                            <td colspan="2" valign="top" style="padding-left:20px!important">
                              <table style="height:35px;font-size:13px!important;">
                                 ...
                                 ?>
                                  <tr><td style="height:25px!important"><div class="cicle_box"><?php echo($k1+1)?></div></td><td>&nbsp;&nbsp;<?php echo$str_dep?></td></tr>
                                 <?php } ?>
                              </table>
        ...
        <div class="col-md-6">
                           <table class="table" width="100%" style="font-size: 15px;">
                            <tr><td colspan="2" style="color:#3599c5"><?php echo$compay_re?></td></tr>
                          <tr>
...
$newformat = date('d-M-Y',$time);
              ...
              $str_rep = str_replace("<->","&nbsp;&nbsp;<i class='fa fa-arrow-circle-right custom'></i>&nbsp;&nbsp;",$checkin_data_ret[$k2]);         
                                 ?>
                                  <tr><td style="height:25px!important"><div class="cicle_box"><?php echo($k2+1)?></div></td><td>&nbsp;&nbsp;<?php echo$str_rep?></td></tr>
                                 <?php } ?>
...
<div style="width:100%;border-style: solid;border-width:0px;">
  <div class="row">
    <div class="col-md-6" style="font-size: 25px;color:#3599c5"><b>Package Detail</b></div>
    <div class="col-md-6" style="text-align: right;"><img src="http://khemtis.com/frontend/assets_bill/images/logo-khemtis-black.png" style="height:auto;width:120px;"></div>
...
<div style="width:100%;border-style: solid;border-width:0px;">
  <div class="row">
    <div class="col-md-6" style="font-size: 25px;color:#3599c5"><b>Resturants Detail</b></div>
    <div class="col-md-6" style="text-align: right;"><img src="http://khemtis.com/frontend/assets_bill/images/logo-khemtis-black.png" style="height:auto;width:120px;"></div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">khemtis massage</h4>
        </div>
        <div class="modal-body">
          <p style="">Room is not enough. Please check again.!</p>
          <div id="show_over_hotel"></div>
        </div>
        <div class="modal-footer">
          <input type="hidden" id="del_temp" value="">
          <?php 
            $hotel_id=$hotel_id;
            $txt_find='';
            $book_st=$book_st_hotel;
            $book_en=$book_en_hotel;
            $Adults=$adu_hotel;
            $Child=$chi_hotel;
          ?>
          <button type="button" class="btn btn-danger" style="background-color: red;color:#ffffff" onclick="del_hotel_list_temp('<?php echo$hotel_id?>','<?php echo$txt_find?>','<?php echo$book_st?>','<?php echo$book_en?>','<?php echo$Adults?>','<?php echo$Child?>')">REORDER</button>
...
<center>
 <!-- Set up a container element for the button -->
    ...
    <div style="font-size:10px;" id="paydef"><img src="https://www.khemtis.com/assets/icon/paypic.jpg"  style="cursor:pointer;" onclick="check_pay()">
    <br>
     confirm payment py khemtis
    </div>
    <div id="text1"></div>
    <br><br>
  ...
  <script>
  $('#paydef').addClass("pay_img");
  function check_pay(){
    var book_st = $('#pay_d_st').val();
    var book_en = $('#pay_d_en').val();
          $.ajax({
                    url: "<?php  echo base_url('Allbook/check_payment')?>",
                    datatype: 'html',
                    type: "POST",
                    data: ({idhd:0,book_st:book_st,book_en:book_en}),
                  success:function(data){
                 //   alert(data);
                 //   alert("กำลังปรับปรุง Modal อยู่ขณะนี้");
              
                    if(data!="No"){
                       $('#myModal').modal('show');
                     $('#paypal-button-container').css("display", "none");
                     $('#paydef').css("display", "block");
                     $('#show_over_hotel').html(data);
                     $('#paydef').addClass("pay_img");
                     }else{

                     $('#paypal-button-container').css("display", "block");
                     $('#paydef').css("display", "none");
                     $('#paydef').removeClass("pay_img");
                     }
  ...
  env: 'sandbox', // sandbox | production
    client: {
      sandbox:'AaMrl2sBOWG7AT39gI3_PTSQPTaElcq2uq9PL1JdUvbV64Vci8J8oW7Srfw6EZmiND_rkd2IWJchzLkL'
    },
  ...
  payment: function(data, actions) {
    ...
    return actions.payment.create({
      payment: {
        transactions: [
          {
            amount: { total: '10', currency: 'THB' }        
          }
        ],
        redirect_urls: {
          return_url: 'https://www.khemtis.com/Voucher',
          cancel_url: 'https://www.khemtis.com/Payment?cancelpay=no'
        }
      }
    });
  },
  ...
  function up_pay(){
    $.post("<?php echo base_url('Payment/up_pay_book')?>", 
        {pay_st:1},
        function(result){
          alert(result);
               if(result>0){
                  window.location = "<?php echo base_url('Voucher')?>";
               }
      },'json');
   }
