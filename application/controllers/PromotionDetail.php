...
class PromotionDetail extends CI_Controller {
    ...
    function index() {
       ...
       $get_detail_pro = $this->Page_model->get_detail_pro($res_id);
...
$data["child"] = $this->input->get("Child");
        $data["get_detail_pro"]=$get_detail_pro;
        $this->load->view('header', $data);
        $this->load->view('promotion_detail_view');
    }
