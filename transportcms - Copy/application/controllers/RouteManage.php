...
class RouteManage extends CI_Controller {
  ...
  public function RouteDetail($route_id =NULL){
	...
	$data["results_service"] = $this->Hotel_model->get_service($idclient);
	$data["results_lang"] = $this->Route_model->get_lang();	
	$data["get_route"]= $this->Route_model->get_Route_detail($route_id);
	$this->load->view('Header',$data);// Load Heder And Script Top Page
	//$this->load->view('Home');
	$this->load->view('RouteManage_view',$data);
	$this->load->view('Footer');// Load Footer And Script Buttom Page
...
?>		
		 ...
		 <div class="card">
             ...
             <h5 class="m-0">
				 ...
				 Travel Time : <?php echo $txtTravelTime?> 
				   ...
				   ?>
					...
					<div>
              			   ...
              			   <div class="form-group row" style="margin-bottom: 0">
                              <label class="col-6 col-form-label"><?php echo $times2->arrive_time?> <i class="fa fa-play"></i> <?php echo $times1?></label>
							   
							  <div class="col-4" align="left">
							   	<button type="button" style="float: right" id="btn_addRoute" class="btn btn-info  waves-effect waves-light btn-sm" onClick="addRoute_detail('<?php echo $times2->id?>','<?php echo $route_id?>','<?php echo $times2->route_type_id?>')"><i class="fa fa-plus-square"></i> Add Detail</button>
								  
								
							  </div> 
							    <div class="col-2" align="left">  
									<button type="button" class="btn btn-warning waves-effect waves-light btn-sm" onClick="deleteTime('<?php echo $times2->id?>' , '<?php echo $times2->arrive_time?> - <?php echo $times1?>','<?php echo $times2->route_type_id?>')"><i class="fa fa-minus-square"></i> Delete time</button> 
							   </div>
                           </div>
