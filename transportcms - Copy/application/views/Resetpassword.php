...
<body>
					...
					<span class="login100-form-logo">
						...
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
                                    ...
                                    <div class="wrap-input100 validate-input" data-validate="Enter password" id="repeatpassword002">
                                        <input class="input100" type="password" id="repeatpassword_002" name="repeatpassword_002" onchange="checkpass(this.value)" placeholder="Repeatpassword" required >
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
    ...
    function savenewpass(){
		...
		$.post('<?php echo base_url('Transport_login/save_newPass')?>' , { pass : pass , myId : myId }  , function(data){
                    if(data ==1){
                        alert('Your password has been reset successfully.');
                        window.location.href='<?php echo base_url('Transport_login')?>';
                    }
