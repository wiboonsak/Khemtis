...
<body>
    ...
    <div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" data-toggle="validator" role="form" action="<?php echo base_url('Transport_login/check_log')?>">
					...
					<div class="container-login100-form-btn" id="loginbotton">
						...
						<input class="" type="text" id="username" name="username" placeholder="Email" >
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
                            <div class="wrap-input100 validate-input" data-validate = "Enter email" id="email002" style="display: none">
						<input class="" type="text" id="email_002" name="email_002" placeholder="Email" >
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
    ...
    function check_Email2(){
		...
		if(email ==''){
            ...
            $.post('<?php echo base_url('TransportMail/check_Email')?>',{ email : email,username:username}, function(data){ 
			
                if(data >0){  
					   
						$.post('<?php echo base_url('TransportMail/mail_forgotPassword')?>' , { email : email , userID : data} , function(data){
							//console.log(data);
							if(data == 1){
