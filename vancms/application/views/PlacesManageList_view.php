                                ...
                                <div class="card-body ">
                                    <div class="row p-b-20">
                                      <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <button id="addRow1" class="btn" style="background-color: #628dab;color:#ffffff;" onclick="window.location.href='<?php echo base_url('PlaceManage')?>'">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column full-width" id="example4">
                                        ...
                                        <thead>
                                            <tr style="background-color:#628dab;color:#ffffff;">
                                                ...
                                                <th>Province</th>
                                                <th>Country</th>
                                                <th style="text-align: center;">Detail Place</th>
...
if(isset($get_place_list)){
 foreach($get_place_list as $value_list){  
    $i++;
    $place_id = $value_list->place_id; 
    $p_province_id = $value_list->province_id; 
    //$hotel_id=$value_list->hotel_idrun;
     /*  if($value_list->published_status == 'Y'){  $ch_p = "lb_yes"; $ch_p2 = 'Yes'; }else{ $ch_p = "lb_no";  $ch_p2 = 'No'; }
       if($value_list->booking_status == 'Y'){  $ch_b = "lb_yes"; $ch_b2 = 'Yes'; }else{ $ch_b = "lb_no"; $ch_b2 = 'No'; }*/
	 
	 $place_title = $this->Place_model->get_place_title($place_id);
	 foreach($place_title as $place_title2){}
	 $place_titleName = $place_title2->place_title;
...
?>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td><?php echo $place_titleName?></td>
                                                <!--<td><?php //echo $value_list->default_quota?></td>-->
                                                <!--<td><?php //echo $value_list->max_extra_bed?></td>-->
                                                <td><?php echo $dis_prov?></td>
                                                <td><?php echo $dis_cty?></td>
                                                <td align="center"> 
                                                <button id="addRow1" class="btn select_bt" onclick="window.location.href='<?php echo base_url('PlaceManage/PlaceDetail/').$place_id?>'">
