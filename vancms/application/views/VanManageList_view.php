                                ...
                                <div class="card-body ">
                                    <div class="row p-b-20">
                                      <div class="col-md-6 col-sm-6 col-6">
                                            <div class="btn-group">
                                                <button id="addRow1" class="btn" style="background-color: #628dab;color:#ffffff;" onclick="window.location.href='<?php echo base_url('VanManage')?>'">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column full-width" id="example4">
                                        ...
                                        <thead>
                                            <tr style="background-color:#628dab;color:#ffffff;">
                                                ...
                                                <th style="text-align: center;"> Detail Van </th>
...
if(isset($get_Van_list)){
 foreach($get_Van_list as $value_list){  
    ...
    //$hotel_id=$value_list->hotel_idrun;
	 ...
	 $car_title = $this->Van_model->get_Van_title($car_id);
	 foreach($car_title as $car_title2){}

?>

                                            <tr class="odd gradeX">
                                                <td style="text-align: center;"><?php echo $i;?></td>
                                                <td><?php echo $car_title2->car_title?></td>
                                                ...
                                                <td><div class="<?php echo $ch_b?>"><?php echo $ch_b2?></div></td>
                                                <td align="center"> 
                                                <button id="addRow1" class="btn select_bt" onclick="window.location.href='<?php echo base_url('VanManage/VanDetail/').$car_id?>'">
