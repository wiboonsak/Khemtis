...
class HotelMail extends CI_Controller {
	...
	public function check_Email(){ 		
		...
		$result = $this->HotelMail_model->do_checkEmail($mail,$username);
		echo $result;
	...
	public function mail_forgotPassword(){	 
		...
		$userID = $this->input->post('userID');
             ...
             $user_data = $this->HotelMail_model->get_user($userID);
             foreach($user_data->result() as $user_data2){ }
             $name = $user_data2->user_full_name;
             $url = 'Hotel_login/ResetPassword';
