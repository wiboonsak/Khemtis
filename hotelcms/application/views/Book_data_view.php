...
<div style="height:45px;width:100%;background-color:#f2f2f2;margin-left:20px">
  ...
  <tr>
    ...
    <td><div class="ble" style="cursor:pointer;" onclick="show_hotel_book('1','<?php echo$tokengenered?>')">Paid</div></td>
    <td><div class="grn" style="cursor:pointer;" onclick="show_hotel_book('0','<?php echo$tokengenered?>')">Pending</div></td>
  </tr>
  </table>
...
$sum3=0;
     $txt = "";
	//$txt="<font color='#cccccc'>None Confirm</font>";
if(isset($get_booking)){
//echo $com_price;
  foreach($get_booking as $value_list){
  $i++;
  //$comm_price = $com_price;
  $str = $value_list->str_st;
  $booking_number = $value_list->booking_number;
  $pre_booking_id = $value_list->pre_booking_id;
  $total_comm_sum = $value_list->total_comm;
  if($str=="1"){$txt="<div class='ble'>Paid</div>";}
  else if($str=="0"){$txt="<div class='grn'>Pending</div>";}
  else if($str=="1"){
    $txt="<div class='grn'>Paid</div>";
  }

      $sum_total=0;$list_room=0;$sumtotal = 0;
      $book_room_detail= $this->Room_model->get_book_hotel_detail($pre_booking_id,"HT");
           ...
           <!-- <td style="text-align:right"><?php //echo number_format($room_price,2)?></td>
            ...
            <td style="text-align:right"><?php //echo number_format($room_total,2)?></td>-->
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td style="text-align: center;"><?php echo cvd($value_list->add_date)?></td>
                                                <td><?php echo $value_list->cus_first_name?>&nbsp;&nbsp;<?php echo $value_list->cus_last_name?></td>
                                                <td><?php echo $value_list->cus_phone?></td>
                                                <td><?php echo $value_list->cus_email?></td>
                                                ...
                                                <td style="text-align: right;">
                                                	<font style=" border-bottom: 1px solid;"><?php echo number_format($sumtotal-$comis,2)?></font>
                                                </td>
                                                <td align="center"> 
                                                <button id="addRow1" class="btn select_bt"  onclick="myPopup('<?php echo base_url("HotelVoucher?hotel_id_book=".$pre_booking_id)?>&str=<?php echo$str?>', 'web', 1300, 800)">
...
<?php  }}?>
<tr><td colspan="6" style="text-align: right;"></td><td  style="text-align: right;"><font style=" border-bottom: 3px double;font-weight: bold;"><?php echo number_format($sum1,2)?></td><td  style="text-align: right;"><font style=" border-bottom: 3px double;font-weight: bold;"><?php echo number_format($sum2,2)?></td><td  style="text-align: right;"><font style=" border-bottom: 3px double;font-weight: bold;"><?php echo number_format($sum3,2)?></td><td  style="text-align: center;">THB</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
