...
<div class="row">
                        <div class="col-md-12">
                            <div class="card card-topline-gray">
                                <div class="card-head">
                                    <header>Rooms Season Price</header>
                                    <div class="tools">
...
?>
                                            <tr class="odd gradeX">
                                                ...
                                                <td align="center"> 
                                                <button id="addRow1" class="btn select_bt"  onclick="window.location='RoomSeason?autorunid=<?php echo$room_id?>&hotelid=<?php echo$hotel_id?>&typ=Update&token_id=<?php echo$tokengenered?>'">
