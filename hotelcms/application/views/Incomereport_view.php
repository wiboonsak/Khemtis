...
if(isset($sum_all))
{
         $ar_h = explode(':',$sum_all['n_h']);
         if(isset($ar_h[0]) && $ar_h[0]!=""){$nnum_ht = $ar_h[1];}else{$nnum_ht=0;}
   ...
   $sum_all_service_com = ($hotel_comm1);
...
<td></td>
<td></td>
<td><?php echo number_format($h_sumall,2)?></td>
<td><?php echo number_format($hc_sumall,2)?></td>
<!--
...
if(date1>date2){
	...
	window.location="http://hotelcms.khemtis.com/Incomereport";
}else{
   window.location="http://hotelcms.khemtis.com/Incomereport?dc1="+dc1+"&mc1="+mc1+"&yc1="+yc1+"&dc2="+dc2+"&mc2="+mc2+"&yc2="+yc2;
}
}
