...
<div style="width:100%;text-align: center;">
				...
				<form class="login100-form validate-form" method="post" data-toggle="validator" role="form" action="<?php echo base_url('Package_login/check_log')?>">
    ...
    function check_Email2(){
		...
		var username = $('#username').val();	
		 if (username == ''){  
            ...
            $.post('<?php echo base_url('PackageMail/check_Email')?>',{ email : email,username:username}, function(data){ 
			
                if(data >0){  
					   
						$.post('<?php echo base_url('PackageMail/mail_forgotPassword')?>' , { email : email , userID : data} , function(data){
							//console.log(data);
							if(data == 1){
