...
class PackageMail extends CI_Controller {
	 ...
	 */
	 function __construct() {
       parent::__construct();
          $this->load->model('PackageMail_model');
    }
	//--------------------
	...
	public function check_Email(){ 		
		...
		$result = $this->PackageMail_model->do_checkEmail($mail,$username);
		echo $result;
	...
	public function mail_forgotPassword(){	 
		...
		$userID = $this->input->post('userID');
             ...
             $user_data = $this->PackageMail_model->get_user($userID);
             foreach($user_data->result() as $user_data2){ }
             $name = $user_data2->user_full_name;
             $url = 'Package_login/ResetPassword';
      ...
      <td height="355" align="center" valign="top" bgcolor="#FFFFFF"><p>&nbsp;</p>
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tbody>
            ...
            <tr>
              <td height="81" colspan="3"><br>You recently asked to reset your http://packagecms.khemtis.com  password. To complete your request, please follow this link: Click to change<br></td>
            </tr>
            <tr>
